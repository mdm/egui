...
impl Key {
    ...
    /// Convert from physical key names used by browsers to `Key`.
    /// Names are accodring to <https://developer.mozilla.org/en-US/docs/Web/API/UI_Events/Keyboard_event_code_values>
    pub fn from_physical_name(code: &str) -> Option<Self> {
        Some(match code {
            // Commands:
            ...
            "Equal" => Self::Equals,
            "Semicolon" => Self::Semicolon,
            "BracketLeft" => Self::OpenBracket,
            "BracketRight" => Self::CloseBracket,
            "Backquote" => Self::Backtick,
            "Backslash" => Self::Backslash,
            "Slash" => Self::Slash,
            "Quote" => Self::Quote,
            // Digits:
