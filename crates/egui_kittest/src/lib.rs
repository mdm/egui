...
impl<'a, State> Harness<'a, State> {
    ...
    ///
    /// For e.g. [`Key::character('a')`](egui::KeyExt::character) + [`Key::character('b')`](egui::KeyExt::character) this would generate:
    /// - Press [`Key::character('a')`](egui::KeyExt::character)
    /// - Press [`Key::character('b')`](egui::KeyExt::character)
    /// - Release [`Key::character('b')`](egui::KeyExt::character)
    /// - Release [`Key::character('a')`](egui::KeyExt::character)
    ...
    ///
    /// For e.g. [`ModifierPattern::COMMAND`] + [`Key::character('a')`](egui::KeyExt::character) + [`Key::character('b')`](egui::KeyExt::character) this would generate:
